...
class ThreeLayerConvNet(object):
    ...
    def __init__(self, input_dim=(3, 32, 32), num_filters=32, filter_size=7,
        ...
        # Output dataof conv, of shape (F, H', W')
        # Output data of pool, of shape (F, H/2, W/2) 
        # Biases, of shape (hidden_dim)
        self.params['W2'] = weight_scale * np.random.randn(num_filters * int(H/2) * int(W/2), hidden_dim)
        self.params['b2'] = np.zeros([hidden_dim])

        # Output data of affine, of shape (hidden_dim)
        # Output data of relu, of shape (hidden_dim) 
        # Biases, of shape (classes)
